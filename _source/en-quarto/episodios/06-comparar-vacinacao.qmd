...
+ Complete tutorials [Simulating transmission](02-simular-transmissao.qmd), [Modelling interventions](04-modelar-intervencoes.qmd) and [Comparing public health outcomes of interventions](05-comparar-intervencoes.qmd). 
...
There exists a target threshold of vaccination based on the basic reproduction number $R_0$ to achieve [herd immunity](../glossario.qmd#herdimmunity).
...
We will use the same contact matrix as above from [Modelling interventions](04-modelar-intervencoes.qmd):
