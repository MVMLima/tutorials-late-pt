...
+ Complete tutorial [simulating transmission](02-simular-transmissao.qmd)
:::
...
### Do we need a [deterministic](../glossario.qmd#deterministic) or [stochastic](../glossario.qmd#stochastic) model? 
...
For example, [direct](../glossario.qmd#direct) or [indirect](../glossario.qmd#indirect), [airborne](../glossario.qmd#airborne) or [vector-borne](../glossario.qmd#vectorborne).
:::
...
We discuss interventions in detail in the tutorial [Modelling interventions](04-modelar-intervencoes.qmd).
...
Adapt the code from the [accounting for uncertainty](02-simular-transmissao.qmd#accounting-for-uncertainty) section
